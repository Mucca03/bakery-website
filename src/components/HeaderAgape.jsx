...
const HeaderAgape = () => {
    return (
        <nav className="bg-agapeHeader border-gray-200 px-4 lg:px-6 py-2.5">
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                ...
                <div className="bg-white rounded-full inset-shadow-sm inset-shadow-neutral-400 px-7 py-3 text-xl hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1"
                     id="mobile-menu-2">
                    <ul className="flex flex-col mt-4 font-[400] lg:flex-row lg:space-x-24 lg:mt-0">
                        <li>
                            <a href="#"
