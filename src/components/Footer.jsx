...
const Footer = () => {
    return (
        <section className="max-w-screen-xl mx-auto relative overflow-hidden bg-bg-primary px-6 py-20">
            <img
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 font-poppins gap-10 mt-15 pb-10 object-cover relative">
                ...
                <div className="space-y-10 mx-auto">
                        ...
                        <h1 className="text-center font-light text-2xl sm:text-4xl text-primary-dark">¡Visítanos en Redes sociales <br />
                            y ordena ahora!</h1>
